...
class Simulation:
    ...
    def print_capacity_info(self) -> None:
        ...
        for connection, count in self.connection_occupancy.items():
            if count > 0:
                print(f"Connection {connection.name}: {count} / "
